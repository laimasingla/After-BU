...
public class CardManagementDaoImpl implements CustomerDao, BankDao {
	...
	static {
		...
		DebitCardBean debit1 = new DebitCardBean(new BigInteger("1234567890"), new BigInteger("1234567891012131"), true,
				"Mohit Pursnani", 067, 2131, LocalDate.of(2024, Month.JULY, 30), "7894561239632587", "Platinum");
		DebitCardBean debit2 = new DebitCardBean(new BigInteger("1234567890"), new BigInteger("4321562391012233"), true,
				"Mohit Pursnani", 057, 2233, LocalDate.of(2022, Month.AUGUST, 30), "7894561239632587", "Silver");
		...
		CreditCardBean credit1 = new CreditCardBean(new BigInteger("6789101213259898"), true, "Mohit Pursnani", 623,
				9898, LocalDate.of(2023, Month.JUNE, 30), "7894561239632587", "Gold", 200, new BigDecimal("1000000.00"), 68900600.0);
		...
		CreditCardTransaction credittrans1 = new CreditCardTransaction("CRED101", "7894561239632587",
				new BigInteger("6789101213259898"), LocalDateTime.of(2019, Month.OCTOBER, 12, 11, 54, 6),
				new BigDecimal("5000"), "Shopping");
		CreditCardTransaction credittrans2 = new CreditCardTransaction("CRED102", "7894561239632587",
				new BigInteger("6789101213259898"), LocalDateTime.of(2019, Month.SEPTEMBER, 25, 23, 21, 6),
